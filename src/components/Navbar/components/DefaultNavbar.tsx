...
// Importing specific icons from @mui/icons-material
...
import { NavBarActionType } from "./Navbar-client";
                ...
                >
                  {cols.map((col, index) => (
                    <Fragment key={col.name}>
                      ...
                      {col.collapse.map((item: RouteItem) => (
                        <MKTypography
                          key={item.name}
                          component={item.route ? Link : MuiLink} //component={item.route ? Link : MuiLink}

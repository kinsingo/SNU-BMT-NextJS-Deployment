...
export default function ConfirmModal({isModalOpen, onConfirm, onClose,  title = "Are you sure?", content = "You can't undo this action"}) {

  return (
    <MKBox component="section" py={6}>
      <Container>
        <Modal open={isModalOpen} onClose={onClose} sx={{ display: "grid", placeItems: "center" }}>
          <Slide direction="down" in={isModalOpen} timeout={500}>
            ...
            >
              ...
              <MKBox display="flex" justifyContent="right" gap={2} p={1.5}>
                ...
                <MKButton variant="gradient" color="primary" onClick={onConfirm}>
                  save changes
                </MKButton>
              </MKBox>
            </MKBox>
